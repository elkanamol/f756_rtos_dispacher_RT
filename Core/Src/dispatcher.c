...
{
    DEBUG_INFO("Dispatcher Task Started\n");
        ...
        if (xQueueReceive(xDispacherQueue, &recievedEvent, portMAX_DELAY) == pdTRUE)
        {
            ...
            switch (recievedEvent.eventCode)
            {
                case EVENT_CODE_POLICE:
                    ...
                    DEBUG_INFO("Sent event to police queue\n");
                ...
                case EVENT_CODE_AMBULANCE:
                    ...
                    DEBUG_INFO("Sent event to ambulance queue\n");
                ...
                case EVENT_CODE_FIRE:
                    ...
                    DEBUG_INFO("Sent event to fire fighter queue\n");
                ...
                case EVENT_CODE_CORONA:
                    ...
                    DEBUG_INFO("Sent event to corona queue\n");
                    DEBUG_GPIO_OFF(DEBUG_CORONA_PORT, DEBUG_CORONA_PIN);
                    break;
                default:
                    DEBUG_ERROR("Invalid event code\n");
                    break;
            }
...
BaseType_t xStartDispacherTask(UBaseType_t uxPriority)
{
    ...
    {
        DEBUG_ERROR("Error: Failed to create dispacher queue\n");
        return pdFAIL;
    }
    ...
    {
        DEBUG_ERROR("Error creating task DispacherTask\n");
        xReturn = pdFAIL;
    }
